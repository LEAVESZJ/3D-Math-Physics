...
#define SCALE_MIN			0.1f				// 最小拡大率
#define SCALE_MAX			2.0f				// 最大拡大率
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Render_4_3" ),
