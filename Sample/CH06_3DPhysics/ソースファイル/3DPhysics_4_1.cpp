...
#define WEIGHT_NUM					1					// おもり数
#define CENTER_HEIGHT				3.0f				// 中立点高さ
#define SPRING_K					0.002f				// ばね定数
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "3DPhysics_4_1" ),
