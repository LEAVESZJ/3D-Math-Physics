...
int DrawChangingPictures( void )						// 画像の描画
{
	...
	for ( i = 0; i < CORNER_NUM / 2; i++ ) {
		p1 = ConvertRTPToXYZ( R, fTheta1, fPhi1 );	// 頂点1
		p2 = ConvertRTPToXYZ( R, fTheta1, fPhi2 );	// 頂点2
		p3 = ConvertRTPToXYZ( R, fTheta2, fPhi1 );	// 頂点3
		p4 = ConvertRTPToXYZ( R, fTheta2, fPhi2 );	// 頂点4
...
int WINAPI _tWinMain( HINSTANCE hInst, HINSTANCE, LPTSTR, int )
{
    ...
    g_hWnd = CreateWindow( _T( "D3D Sample" ), _T( "Polygons_4_1" ),
